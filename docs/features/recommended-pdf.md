...
| a simplified-Chinese scan | `--ocr-engine rapidocr --ocr-lang iso:zh` | lowest Han error in the measurement | [Which OCR engine](pdf-ocr-engines.md) |
| on a Mac, and you want no download | `--ocr-engine ocrmac` (pip install ocrmac; auto picks it once installed) | Apple's Vision framework; best on English here, rapidocr better on simplified Chinese scans | [Which OCR engine](pdf-ocr-engines.md) |
